...
export default function App() {
  ...
  function selectAvailableSeat(name, newSeatId) {
  ...
  function makeSeatAvailable(name, newSeatId) {
    const newSelectedSeats = {...selectedSeats};
  ...
  function checkSeatAvailability ({name, id:newSeatId, seatClass}) {
    if (seatClass === "unavailable") {
      alert("Este assento não está disponível!");
      return;
    } else if (seatClass === "available") {
        selectAvailableSeat(name, newSeatId);
    } else if (seatClass === "selected") {
        makeSeatAvailable(name, newSeatId);
    }
  }
